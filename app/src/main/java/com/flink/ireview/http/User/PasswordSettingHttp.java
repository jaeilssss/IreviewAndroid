...
public class PasswordSettingHttp {
    private static final String Tag = "HttpSender";
    private static final String Url = "http://172.30.1.10:8081/";
    protected String apiName;
    String data;
    protected RequestBody body;
    public void setBodyContents(Object... params) {
        // 스프링 부트는 account 를 username 으로 써야 인식됌!!!
        body = new FormEncodingBuilder().add("password", String.valueOf(params[0]))
                .add("id", String.valueOf(params[1]))
                .build();
    }
    public String send(){
        try {
            AsyncTask<String, Void, String> asyncTask = new AsyncTask<String, Void, String>() {
                ...
                protected String doInBackground(String... strings) {
                    ...
                    apiName = "api/member/setting/password";
